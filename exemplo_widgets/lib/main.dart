...
// Método build, obrigatório em StatelessWidget, retorna a árvore dewidgets da aplicação
  @override
    ...
    children: [
      Expanded(
        child: Column(
          ...
          children: [
            Text('Filho Alinhado 1', textAlign: TextAlign.left),
          ],
        ),
      ),
      SizedBox(width: 16), // Espaçamento entre os filhos
      Expanded(
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Text('Filho Alinhado 2', textAlign: TextAlign.left),
          ],
        ),
      ),
    ],
